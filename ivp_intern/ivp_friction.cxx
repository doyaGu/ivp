...
// IVP_Contact_Point::friction_force_local_constraint_2d_wheel is defined in
// ivp_controller/ivp_car_wheel_physics.cxx to avoid depending on ivp_constraint_car.hxx.
...
// friction_force_local_constraint_2d_wheel is in ivp_controller/ivp_car_wheel_physics.cxx
...
IVP_Contact_Point::~IVP_Contact_Point()
{
	...
	syn1->get_object()->get_surface_manager()->remove_reference_to_ledge(syn1->edge->get_compact_ledge());
	{
		...
		// Set contact point and surface normal for delete notification.
	...
	{
		IVP_Core *core0 = NULL, *core1 = NULL;
		IVP_IF(env->get_debug_manager()->check_fs)
		{
...
{
	// Use cached surface normal as tmp_contact_info
	// is nulled in debug_clean_tmp_info.
