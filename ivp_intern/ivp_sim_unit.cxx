...
void IVP_Simulation_Unit::sim_unit_sort_controllers()
{
    ...
    while (1)
    {
        ...
        if (controller_cores.element_at(first)->l_controller->get_controller_priority() > second_prio)
        {
            ...
            int test_pos = first;
            while ((test_pos > 0) && (controller_cores.element_at(test_pos - 1)->l_controller->get_controller_priority() > second_prio))
            { // controller_cores.element_at(test_pos)->l_controller->get_controller_priority() ) ) {
