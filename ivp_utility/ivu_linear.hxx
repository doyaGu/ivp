...
{
public:
    static inline IVP_RETURN_TYPE invert_2x2_matrix(const IVP_DOUBLE a1_in, const IVP_DOUBLE b1_in, const IVP_DOUBLE a2_in, const IVP_DOUBLE b2_in, IVP_DOUBLE *i_a1_out, IVP_DOUBLE *i_b1_out, IVP_DOUBLE *i_a2_out, IVP_DOUBLE *i_b2_out);
...
#else
    static IVP_DOUBLE ivp_sqrtf(IVP_DOUBLE f)
    {
        return sqrtf(f);
    };
#endif
    static IVP_DOUBLE sqrtd(IVP_DOUBLE f)
    {
        return ivp_sqrtf(f);
    };
    static IVP_DOUBLE ivp_sinf(IVP_DOUBLE f)
    {
        return sinf(f);
    };
    static IVP_DOUBLE ivp_cosf(IVP_DOUBLE f)
    {
        return cosf(f);
    };
    static IVP_DOUBLE sind(IVP_DOUBLE f)
    {
        return sinf(f);
    };
    static IVP_DOUBLE cosd(IVP_DOUBLE f)
    {
        return cosf(f);
    };
    static IVP_DOUBLE acosd(IVP_DOUBLE f)
    {
        return acosf(f);
    };
    static IVP_DOUBLE asind(IVP_DOUBLE f)
    {
        return asinf(f);
    };
    static IVP_DOUBLE atand(IVP_DOUBLE f)
    {
        return atanf(f);
    };
    static IVP_DOUBLE ivp_expf(IVP_DOUBLE f)
    {
        return expf(f);
    };
...
public:
    ...
    void set_matrix(const IVP_U_Matrix *mat)
    {
        *this = *mat;
    }
...
public:
    ...
    IVP_U_Quat(const IVP_U_Matrix3 *m)
    {
