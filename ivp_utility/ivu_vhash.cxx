...
void IVP_VHash::print() const
{
    ...
    {
        printf(" %i:%X:%X  ",
               elems[i].hash_index & size_mm,
               (int)(intp)elems[i].elem,
               elems[i].hash_index);
    }
    printf("\n");
}
 ...
 *                works only with pointers as key elements and pointers as additional associated
 *elements
 *******************************************************************************************************************/
...
void IVP_VHash_Store::print()
{
    ...
    {
        printf(" %i:%X:%X:%X  ",
               elems_store[i].hash_index & size_mm,
               (int)(intp)elems_store[i].key_elem,
               (int)(intp)elems_store[i].elem,
