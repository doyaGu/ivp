#ifndef IVP_U_GEOMETRY_INCLUDED
#define IVP_U_GEOMETRY_INCLUDED
...
public:
    ...
    IVP_U_INTERSECT_TYPE calc_intersect_with(const IVP_U_Straight *straight2, IVP_U_Point *p_out, IVP_DOUBLE *dist_out); // ATT: 0-3 as result!
