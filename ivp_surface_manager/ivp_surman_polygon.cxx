    ...
    IVP_U_BigVector<IVP_Compact_Ledge> *resulting_ledges)
{
    ...
    // if ( this->traversion_depth > this->max_traversion_depth ) this->max_traversion_depth =
    // this->traversion_depth;
    ...
    // max_z); printf("Intruder: %f - %f *** %f - %f *** %f - %f\n", s_bb_min_x, s_bb_max_x,
    // s_bb_min_y, s_bb_max_y, s_bb_min_z, s_bb_max_z);
#endif
    ...
    if (node->is_terminal())
    {
        ...
        {  // IVP_DOUBLE triangle allows deeper search
            ...
            IVP_DOUBLE qdist =
                IVP_CLS.calc_qlen_PF_F_space(ledge, triangle, visitor_position_object_space);
    ...
    IVP_U_BigVector<IVP_Compact_Ledge> *resulting_ledges)
{
    ...
    else
    {
        ...
        sps.traverse_cluster(
            root_node->right_son(), visitor_position_object_space, radius, resulting_ledges);
    }
    return;
}
