...
IVP_Actuator_Spring_Active::IVP_Actuator_Spring_Active(IVP_Environment *env, IVP_Template_Spring *spring_templ)
...
IVP_Actuator_Suspension::IVP_Actuator_Suspension(IVP_Environment *env, IVP_Template_Suspension *templ)
...
{
	if (spring_dampening_compression == comp)
		return;
...
void IVP_Actuator_Suspension::do_simulation_controller(IVP_Event_Sim *es, IVP_U_Vector<IVP_Core> * /*core_list*/)
{
	...
	if (0)
	{
		// Version with new IVP_Solver_Core_Reaction
