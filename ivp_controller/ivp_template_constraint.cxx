...
void IVP_Template_Constraint::set_fixing_point_Ros(const IVP_U_Point *anchor)
{ // point_Ros_f_uRfs
	m_Ros_f_Rfs = &mm_Ros_f_Rfs;
	m_Ros_f_Rfs->vv.set(anchor);
}

void IVP_Template_Constraint::set_translation_axes_Ros(const IVP_U_Matrix3 *trans_axes)
{ // m_Ros_f_uRfs
	m_Ros_f_Rfs = &mm_Ros_f_Rfs;
