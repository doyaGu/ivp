...
IVP_Actuator_Force::IVP_Actuator_Force(IVP_Environment *env, IVP_Template_Force *templ) : IVP_Actuator_Two_Point(env, templ, IVP_ACTUATOR_TYPE_FORCE)
{
...
IVP_Actuator_Force_Active::IVP_Actuator_Force_Active(IVP_Environment *env, IVP_Template_Force *templ) : IVP_Actuator_Force(env, templ)
{
...
IVP_Actuator_Extra::IVP_Actuator_Extra(IVP_Environment *env, IVP_Template_Extra *templ) : IVP_Actuator_Two_Point(env, templ, IVP_ACTUATOR_TYPE_ETC)
{
    ...
    if (this->info.mod_fc_height)
        info.mod_fc_height->add_dependency(this);
    if (this->info.mod_fc_target_height)
        info.mod_fc_target_height->add_dependency(this);
    if (this->info.mod_fc_dist)
        info.mod_fc_dist->add_dependency(this);
    if (this->info.mod_fc_speed)
        info.mod_fc_speed->add_dependency(this);
...
{
    if (info.mod_fc_height)
        info.mod_fc_height->remove_dependency(this);
    if (info.mod_fc_target_height)
        info.mod_fc_target_height->remove_dependency(this);
    if (info.mod_fc_dist)
        info.mod_fc_dist->remove_dependency(this);
    if (info.mod_fc_speed)
        info.mod_fc_speed->remove_dependency(this);

    if (info.active_float_force)
        info.active_float_force->remove_dependency(this);
    if (info.active_float_bomb)
        info.active_float_bomb->remove_dependency(this);
...
IVP_Actuator_Rot_Mot::IVP_Actuator_Rot_Mot(IVP_Environment *env, IVP_Template_Rot_Mot *templ) : IVP_Actuator_Two_Point(env, templ, IVP_ACTUATOR_TYPE_ROT_MOT)
{
...
IVP_Actuator_Rot_Mot_Active::IVP_Actuator_Rot_Mot_Active(IVP_Environment *env, IVP_Template_Rot_Mot *templ) : IVP_Actuator_Rot_Mot(env, templ)
{
...
IVP_Actuator_Torque_Active::IVP_Actuator_Torque_Active(IVP_Environment *env, IVP_Template_Torque *templ) : IVP_Actuator_Torque(env, templ)
{
    active_float_max_rotation_speed = templ->active_float_max_rotation_speed;
...
void IVP_Actuator_Torque_Active::active_float_changed(IVP_U_Active_Float *af)
{
    ...
    if (af == active_float_torque)
        set_torque(af->get_float_value());
}
...
IVP_Actuator_Stabilizer::IVP_Actuator_Stabilizer(IVP_Environment *env, IVP_Template_Stabilizer *templ) : IVP_Actuator_Four_Point(env, templ, IVP_ACTUATOR_TYPE_STABILIZER)
{
    l_environment = env;
