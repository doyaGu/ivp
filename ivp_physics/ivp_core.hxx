...
public:
    ...
    IVP_U_Float_Point *spin_clipping; // if set, than angular velocities are individually clipped
                                      // against this value
...
public:
    ...
    inline void calc_next_PSI_matrix(IVP_U_Vector<IVP_Core> *cores_which_needs_calc_next_psi, class IVP_Event_Sim *)
    {
