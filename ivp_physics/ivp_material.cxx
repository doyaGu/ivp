...
{
    return sit->materials[0]->get_friction_factor() * sit->materials[1]->get_friction_factor();
}

IVP_DOUBLE IVP_Material_Manager::get_elasticity(IVP_Contact_Situation *sit)
{
    return sit->materials[0]->get_elasticity() * sit->materials[1]->get_elasticity();
}
...
IVP_Material *IVP_Material_Manager::get_material_by_index(const IVP_U_Point * /*world_position*/, int /*index*/)
{
    // returns the material, if material index in compact_triangle != 0
