...
class IVP_Collision_Delegator
{
  public:
    ...
    virtual int get_spawned_mindist_count()
    {
        return -1;
    }
    //@@CB
...
class IVP_Collision_Delegator_Root : public IVP_Collision_Delegator
{
  public:
     ...
     *	Description:	create a subclass which checks collisions between the base_object and the
     *colliding_element Return:		NULL if type of objects cannot be handled
     ********************************************************************************/
...
class IVP_Collision : public IVP_Time_Event
{
  public:
    ...
    int get_fvector_index(int i) const
    {
        return fvector_index[i];
    }
