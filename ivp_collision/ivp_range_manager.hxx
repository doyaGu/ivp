...
#ifndef IVP_COLLISION_RANGE_MANAGER_INCLUDED
#define IVP_COLLISION_RANGE_MANAGER_INCLUDED
...
public:
    ...
    virtual void get_coll_range_intra_objects(const IVP_Real_Object *obj0, const IVP_Real_Object *obj1, IVP_DOUBLE *range0, IVP_DOUBLE *range1);
