...
#ifndef IVP_COLLISION_MINDIST_INTERN_INCLUDED
#define IVP_COLLISION_MINDIST_INTERN_INCLUDED
...
enum IVP_COLL_TYPE
{  // if last 4 bits == 0 then collision
    IVP_COLL_NONE = 0x00,
...
#endif // IVP_COLLISION_MINDIST_INTERN_INCLUDED
