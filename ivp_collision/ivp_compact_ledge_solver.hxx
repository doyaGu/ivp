...
class IVP_Compact_Ledge_Solver
{
  ...
  public:
    ...
    IVP_STATIC void calc_unscaled_qr_vals_F_space(const IVP_Compact_Ledge *c_ledge, const IVP_Compact_Edge *tri, const IVP_U_Point *object_point, IVP_Unscaled_QR_Result *result);
  ...
  public:
    ...
    IVP_STATIC void calc_radius_to_given_center(const IVP_Compact_Surface *c_surface_in, const IVP_U_Point *center_in, IVP_DOUBLE *radius_out, IVP_DOUBLE *radius_dev_out = 0);
#ifdef HAVOK_MOPP
    IVP_STATIC void calc_radius_to_given_center(const class IVP_Compact_Mopp *c_mopp_in, const IVP_U_Point *center_in, IVP_DOUBLE *radius_out, IVP_DOUBLE *radius_dev_out = 0);
#endif                                                                                                           // HAVOK_MOPP
