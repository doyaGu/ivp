...
void IVP_Compact_Ledge_Solver::get_all_ledges(const IVP_Compact_Mopp *mopp, IVP_U_BigVector<IVP_Compact_Ledge> *all_ledges_out)
{
    ...
    do
    {
        ...
        // ledge = (IVP_Compact_Ledge*)((char*)ledge + 48); // @@CB big hack !! only supports
        // triangles !!
    } while (ledge != point0);
                                                           ...
                                                           IVP_DOUBLE *radius_dev_out)
{
    ...
    int t;
    for (t = ledge->get_n_triangles() - 1, tri = ledge->get_first_triangle(); t >= 0; t--, tri = tri->get_next_tri())
    {
...
void IVP_Compact_Ledge_Solver::calc_pos_other_space(const IVP_Compact_Edge *P,
...
void IVP_Compact_Ledge_Solver::transform_vec_other_space(const IVP_U_Point *dir_os,
...
void IVP_Compact_Ledge_Solver::transform_pos_other_space(const IVP_U_Float_Point *pos_in_os,
                                                         IVP_Cache_Ledge_Point *m_cache_dir,
                                                         IVP_Cache_Ledge_Point *m_cache_other_space,
                                                         IVP_U_Point *res)
{
 ...
 ********************************************************************************/
IVP_DOUBLE IVP_Compact_Ledge_Solver::calc_s_val(const IVP_Compact_Edge *edge,
...
void IVP_Compact_Ledge_Solver::calc_unscaled_s_val_K_space(const IVP_Compact_Ledge *c_ledge,
                                                           const IVP_Compact_Edge *edge,
...
// for debugging only
#ifdef DEBUG
void IVP_Compact_Ledge_Solver::calc_qr_vals(const IVP_Compact_Edge *e_tri,
                                            const IVP_U_Point *p_world,
                                            IVP_DOUBLE *out_q,
                                            IVP_DOUBLE *out_r,
...
IVP_DOUBLE IVP_KK_Input::calc_quad_distance_edge_edge()
{
    ...
    if (quad_dist > (P_DOUBLE_RES * P_DOUBLE_RES))
    {  // not parallel
...
IVP_DOUBLE IVP_Compact_Ledge_Solver::calc_qlen_PF_F_space(const IVP_Compact_Ledge *ledge, const IVP_Compact_Triangle *tri, const IVP_U_Point *object_pos)
{
    ...
    for (int i = 2; i >= 0; i--)
    {
        ...
        if (sr.checks[1] < 0)
            continue;  // no need to check this case as this point wil be touched with the next edge
